...
public class hs_find extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search = (Button) findViewById(R.id.btn_hs_find_Search);
        btn_write = (Button) findViewById(R.id.btn_hs_find_write);
        btn_notice = (Button) findViewById(R.id.btn_hs_find_notice);
        btn_star = (Button) findViewById(R.id.btn_hs_find_star);

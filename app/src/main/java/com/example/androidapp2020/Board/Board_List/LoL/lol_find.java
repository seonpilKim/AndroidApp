...
public class lol_find extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lol_find); // Link to xml

        listView = (ListView) findViewById(R.id.lv_lol_find);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);

        btn_search = (Button) findViewById(R.id.btn_lol_find_Search);
        btn_write = (Button) findViewById(R.id.btn_lol_find_write);
        btn_notice = (Button) findViewById(R.id.btn_lol_find_notice);
        btn_star = (Button) findViewById(R.id.btn_lol_find_star);
        btn_free = (Button) findViewById(R.id.btn_lol_find_free);
        btn_find = (Button) findViewById(R.id.btn_lol_find_find);
        ...
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(lol_find.this, board_write.class);
        ...
        database.child("Board_list").child("League_of_Legend").child("Find").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/League_of_Legend/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                }
                else {
                    taskMap.put("/Board_list/League_of_Legend/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                }
                database.updateChildren(taskMap);
                views = ((ListVO)adapter.getItem(position)).getViews();

                Intent it_boardItem = new Intent(lol_find.this, BoardItem.class);

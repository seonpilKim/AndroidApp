...
public class etc_find extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_etc_find);
        listView = (ListView) findViewById(R.id.lv_etc_find);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);

        btn_search = (ImageButton) findViewById(R.id.btn_etc_find_Search);
        btn_write = (ImageButton) findViewById(R.id.btn_etc_find_write);
        ...
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(etc_find.this, board_write.class);
        ...
        database.child("Board_list").child("ET_Cetera").child("Find").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/ET_Cetera/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                }
                else {
                    taskMap.put("/Board_list/ET_Cetera/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                }
                database.updateChildren(taskMap);
                views = ((ListVO)adapter.getItem(position)).getViews();

                Intent it_boardItem = new Intent(etc_find.this, BoardItem.class);

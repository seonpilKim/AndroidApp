...
public class AmongUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab.setTitle("어몽어스 공지사항");
        ab.setDisplayHomeAsUpEnabled(true);
        ab.setDisplayShowHomeEnabled(true);

        listView = (ListView) findViewById(R.id.lv_au_notice);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);

        btn_search = (ImageButton) findViewById(R.id.btn_au_notice_Search);
        btn_write = (ImageButton) findViewById(R.id.btn_au_notice_write);
...
// 작성
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(id.equals("228bc064cfc41a98")) {
                    ...
                    it_board_LoL.putExtra("game_type", "AmongUs");
        ...
        database.child("Board_list").child("AmongUs").child("Notice").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/AmongUs/Notice/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                    views = ((ListVO)adapter.getItem(position)).getViews();
                }
                else {
                    taskMap.put("/Board_list/AmongUs/Notice/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                    views = ((ListVO)adapter.getItem(position)).getViews();
                }
                database.updateChildren(taskMap);

                Intent it_boardItem = new Intent(AmongUs.this, BoardItem.class);

...
public class ow_free extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header = getLayoutInflater().inflate(R.layout.activity_ow_star, null, false);
        listView = (ListView) findViewById(R.id.lv_ow_free);
        listView2 = (ListView) header.findViewById(R.id.lv_ow_star);
        ...
        btn_star = (Button) findViewById(R.id.btn_ow_free_star);

...
public class ff_star extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ff_star);
        listView = (ListView) findViewById(R.id.lv_ff_star);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);

        btn_search = (Button) findViewById(R.id.btn_ff_star_Search);
        btn_notice = (Button) findViewById(R.id.btn_ff_star_notice);
        btn_star = (Button) findViewById(R.id.btn_ff_star_star);
        btn_free = (Button) findViewById(R.id.btn_ff_star_free);
        btn_find = (Button) findViewById(R.id.btn_ff_star_find);
        et_search = (EditText) findViewById(R.id.et_ff_star_Search);

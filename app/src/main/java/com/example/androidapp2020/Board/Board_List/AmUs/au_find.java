package com.example.androidapp2020.Board.Board_List.AmUs;
...
public class au_find extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_au_find);
        listView = (ListView) findViewById(R.id.lv_au_find);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);

        btn_search = (Button) findViewById(R.id.btn_au_find_Search);
        btn_write = (Button) findViewById(R.id.btn_au_find_write);
        btn_notice = (Button) findViewById(R.id.btn_au_find_notice);
        btn_star = (Button) findViewById(R.id.btn_au_find_star);
        btn_free = (Button) findViewById(R.id.btn_au_find_free);
        btn_find = (Button) findViewById(R.id.btn_au_find_find);
        et_search = (EditText) findViewById(R.id.et_au_find_Search);
        ...
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(au_find.this, board_write.class);
                intent.putExtra("board_type", "Find");
                intent.putExtra("game_type", "AmongUs");
                startActivity(intent);
            }
        });

        database.child("Board_list").child("AmongUs").child("Find").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/AmongUs/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                }
                else {
                    taskMap.put("/Board_list/AmongUs/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                }
                database.updateChildren(taskMap);
                views = ((ListVO)adapter.getItem(position)).getViews();

                Intent it_boardItem = new Intent(au_find.this, BoardItem.class);
                ...
                it_boardItem.putExtra("game_type", "AmongUs");

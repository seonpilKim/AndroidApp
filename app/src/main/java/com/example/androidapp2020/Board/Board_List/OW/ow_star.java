...
public class ow_star extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ow_star);
        listView = (ListView) findViewById(R.id.lv_ow_star);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);

        btn_search = (Button) findViewById(R.id.btn_ow_star_Search);
        btn_notice = (Button) findViewById(R.id.btn_ow_star_notice);
        btn_star = (Button) findViewById(R.id.btn_ow_star_star);
        btn_free = (Button) findViewById(R.id.btn_ow_star_free);
        btn_find = (Button) findViewById(R.id.btn_ow_star_find);
        et_search = (EditText) findViewById(R.id.et_ow_star_Search);

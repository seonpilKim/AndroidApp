...
public class kr_free extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kr_free); ActionBar ab = getSupportActionBar();
        ab.setTitle("카트 자유게시판");
        ab.setDisplayHomeAsUpEnabled(true);
        ab.setDisplayShowHomeEnabled(true);
        header = getLayoutInflater().inflate(R.layout.activity_kr_star, null, false);
        listView = (ListView) findViewById(R.id.lv_kr_free);
        listView2 = (ListView) header.findViewById(R.id.lv_kr_star);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);
        listView2.setAdapter(adapter);


        btn_search = (Button) findViewById(R.id.btn_kr_free_Search);
        btn_write = (Button) findViewById(R.id.btn_kr_free_write);
        btn_notice = (Button) findViewById(R.id.btn_kr_free_notice);
        btn_star = (Button) findViewById(R.id.btn_kr_free_star);
        btn_free = (Button) findViewById(R.id.btn_kr_free_free);
        btn_find = (Button) findViewById(R.id.btn_kr_free_find);
        et_search = (EditText) findViewById(R.id.et_kr_free_Search);
        ...
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(kr_free.this, board_write.class);
        ...
        database.child("Board_list").child("KartRider").child("Free").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/KartRider/Free/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                }
                else {
                    taskMap.put("/Board_list/KartRider/Free/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                }
                database.updateChildren(taskMap);
                views = ((ListVO)adapter.getItem(position)).getViews();

                Intent it_boardItem = new Intent(kr_free.this, BoardItem.class);

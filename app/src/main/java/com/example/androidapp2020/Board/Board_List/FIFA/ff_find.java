...
public class ff_find extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ff_find);
        listView = (ListView) findViewById(R.id.lv_ff_find);
        ...
        btn_star = (Button) findViewById(R.id.btn_ff_find_star);
        btn_free = (Button) findViewById(R.id.btn_ff_find_free);
        btn_find = (Button) findViewById(R.id.btn_ff_find_find);
        et_search = (EditText) findViewById(R.id.et_ff_find_Search);
        ...
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(ff_find.this, board_write.class);
        ...
        database.child("Board_list").child("FifaOnline4").child("Find").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/FifaOnline4/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                }
                else {
                    taskMap.put("/Board_list/FifaOnline4/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                }
                database.updateChildren(taskMap);
                views = ((ListVO)adapter.getItem(position)).getViews();

                Intent it_boardItem = new Intent(ff_find.this, BoardItem.class);

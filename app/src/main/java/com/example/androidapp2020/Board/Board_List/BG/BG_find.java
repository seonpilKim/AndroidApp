...
public class BG_find extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b_g_find);
        listView = (ListView) findViewById(R.id.lv_bg_find);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);

        btn_search = (Button) findViewById(R.id.btn_bg_find_Search);
        btn_write = (Button) findViewById(R.id.btn_bg_find_write);
        btn_notice = (Button) findViewById(R.id.btn_bg_find_notice);
        btn_star = (Button) findViewById(R.id.btn_bg_find_star);
        btn_free = (Button) findViewById(R.id.btn_bg_find_free);
        btn_find = (Button) findViewById(R.id.btn_bg_find_find);
        et_search = (EditText) findViewById(R.id.et_bg_find_Search);
        ...
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(BG_find.this, board_write.class);
        ...
        database.child("Board_list").child("BattleGrounds").child("Find").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/BattleGrounds/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                }
                else {
                    taskMap.put("/Board_list/BattleGrounds/Find/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                }
                database.updateChildren(taskMap);
                views = ((ListVO)adapter.getItem(position)).getViews();

                Intent it_boardItem = new Intent(BG_find.this, BoardItem.class);

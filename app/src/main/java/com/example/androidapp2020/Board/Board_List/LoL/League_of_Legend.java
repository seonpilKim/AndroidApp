...
public class League_of_Legend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search = (ImageButton) findViewById(R.id.btn_lol_notice_Search);
        btn_write = (ImageButton) findViewById(R.id.btn_lol_notice_write);
...
// 작성
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(id.equals("228bc064cfc41a98")) {
                    intent = new Intent(getApplicationContext(), board_write.class);
        ...
        database.child("Board_list").child("League_of_Legend").child("Notice").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/League_of_Legend/Notice/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                }
                else {
                    taskMap.put("/Board_list/League_of_Legend/Notice/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                }

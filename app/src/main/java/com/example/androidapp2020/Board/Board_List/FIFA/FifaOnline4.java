...
public class FifaOnline4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifa_online4);
        ActionBar ab = getSupportActionBar();
        ab.setTitle("피파4 공지사항");
        ab.setDisplayHomeAsUpEnabled(true);
        ab.setDisplayShowHomeEnabled(true);

        listView = (ListView) findViewById(R.id.lv_ff_notice);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);

        btn_search = (Button) findViewById(R.id.btn_ff_notice_Search);
        btn_write = (Button) findViewById(R.id.btn_ff_notice_write);
        btn_notice = (Button) findViewById(R.id.btn_ff_notice_notice);
        btn_star = (Button) findViewById(R.id.btn_ff_notice_star);
        btn_free = (Button) findViewById(R.id.btn_ff_notice_free);
        btn_find = (Button) findViewById(R.id.btn_ff_notice_find);
        et_search = (EditText) findViewById(R.id.et_ff_notice_Search);
...
// 작성
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(id.equals("228bc064cfc41a98")) {
                    ...
                    it_board_LoL.putExtra("game_type", "FifaOnline4");
        ...
        database.child("Board_list").child("FifaOnline4").child("Notice").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/FifaOnline4/Notice/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                    views = ((ListVO)adapter.getItem(position)).getViews();
                }
                else {
                    taskMap.put("/Board_list/FifaOnline4/Notice/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                    views = ((ListVO)adapter.getItem(position)).getViews();
                }
                database.updateChildren(taskMap);

                Intent it_boardItem = new Intent(FifaOnline4.this, BoardItem.class);

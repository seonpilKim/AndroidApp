...
public class au_free extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_au_free);
        ActionBar ab = getSupportActionBar();
        ab.setTitle("어몽어스 자유게시판");
        ab.setDisplayHomeAsUpEnabled(true);
        ab.setDisplayShowHomeEnabled(true);
        header = getLayoutInflater().inflate(R.layout.activity_au_star, null, false);
        listView = (ListView) findViewById(R.id.lv_au_free);
        listView2 = (ListView) header.findViewById(R.id.lv_au_star);
        ...
        btn_star = (Button) findViewById(R.id.btn_au_free_star);
        btn_free = (Button) findViewById(R.id.btn_au_free_free);
        btn_find = (Button) findViewById(R.id.btn_au_free_find);
        et_search = (EditText) findViewById(R.id.et_au_free_Search);
        ...
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(au_free.this, board_write.class);
        ...
        database.child("Board_list").child("AmongUs").child("Free").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/AmongUs/Free/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                }
                else {
                    taskMap.put("/Board_list/AmongUs/Free/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                }
                database.updateChildren(taskMap);
                views = ((ListVO)adapter.getItem(position)).getViews();

                Intent it_boardItem = new Intent(au_free.this, BoardItem.class);

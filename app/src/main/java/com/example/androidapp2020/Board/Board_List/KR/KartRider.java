...
public class KartRider extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kart_rider);
        ActionBar ab = getSupportActionBar();
        ab.setTitle("카트 공지사항");
        ab.setDisplayHomeAsUpEnabled(true);
        ab.setDisplayShowHomeEnabled(true);

        listView = (ListView) findViewById(R.id.lv_kr_notice);
        adapter = new ListViewAdapter(listVO);
        listView.setAdapter(adapter);

        btn_search = (Button) findViewById(R.id.btn_kr_notice_Search);
        btn_write = (Button) findViewById(R.id.btn_kr_notice_write);
        btn_notice = (Button) findViewById(R.id.btn_kr_notice_notice);
        btn_star = (Button) findViewById(R.id.btn_kr_notice_star);
        btn_free = (Button) findViewById(R.id.btn_kr_notice_free);
        btn_find = (Button) findViewById(R.id.btn_kr_notice_find);
        et_search = (EditText) findViewById(R.id.et_kr_notice_Search);
...
// 작성
        btn_write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(id.equals("228bc064cfc41a98")) {
                    ...
                    it_board_LoL.putExtra("game_type", "KartRider");
        ...
        database.child("Board_list").child("KartRider").child("Notice").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long i) {
                ...
                if(id.equals(myid)){
                    taskMap.put("/Board_list/KartRider/Notice/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews());
                    views = ((ListVO)adapter.getItem(position)).getViews();
                }
                else {
                    taskMap.put("/Board_list/KartRider/Notice/" + key + "/views", ((ListVO) adapter.getItem(position)).getViews() + 1);
                    views = ((ListVO)adapter.getItem(position)).getViews();
                }
                database.updateChildren(taskMap);

                Intent it_boardItem = new Intent(KartRider.this, BoardItem.class);
